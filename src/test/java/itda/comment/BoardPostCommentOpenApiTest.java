...
class BoardPostCommentOpenApiTest {
    ...
    void runtimeOpenApiExposesCommentCreateListUpdateAndDeleteContracts() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/posts/{postId}/comments/{commentId}/direct-room'].post").exists())
                ...
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].put").exists())
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].delete").exists())
                ...
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].put.responses['200']").exists())
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].put.responses['400']").exists())
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].delete.responses['400']").exists())
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].put.requestBody").doesNotExist())
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].delete.requestBody").doesNotExist())
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].put.parameters[?(@.name == 'type')].schema.enum[0]")
                        .value(org.hamcrest.Matchers.hasItem("HELPFUL")))
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].put.parameters[?(@.name == 'type')].schema.enum[1]").doesNotExist())
                .andExpect(jsonPath("$.paths['/comments/{commentId}/reactions/{type}'].put.responses['200'].content['*/*'].schema.$ref")
                        .value("#/components/schemas/ApiResponseCommentReactionResponse"))
                ...
                .andExpect(jsonPath("$.paths['/posts/{postId}/comments/{commentId}/direct-room'].post.responses['200'].content['*/*'].schema.$ref")
                        .value("#/components/schemas/ApiResponseEnsureDirectRoomResult"))
                .andExpect(jsonPath("$.paths['/posts/{postId}/comments/{commentId}/direct-room'].post.requestBody").doesNotExist())
                ...
                .andExpect(jsonPath("$.components.schemas.CommentTreeResponse.properties.helpfulCount").exists())
                .andExpect(jsonPath("$.components.schemas.CommentTreeResponse.properties.helpfulByMe").exists())
