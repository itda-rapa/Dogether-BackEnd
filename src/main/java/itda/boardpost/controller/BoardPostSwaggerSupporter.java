...
public interface BoardPostSwaggerSupporter {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "201", description = "게시글 작성 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            examples = @ExampleObject("""
                    {"success":true,"message":"게시글이 등록되었습니다.","data":{"postId":1,"boardId":1,"authorPet":{"petId":2,"publicTag":"dog-2","nickname":"두부","profileUrl":null,"verified":false},"title":"산책 친구 구해요","content":"오늘 저녁 같이 산책해요.","images":[{"mediaId":10,"url":"https://...","displayOrder":0}],"version":0,"createdAt":"2026-08-10T00:00:00Z","updatedAt":"2026-08-10T00:00:00Z"},"error":null}
                    """)))
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "게시글 피드 조회 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            examples = @ExampleObject("""
                    {"success":true,"message":"게시글 목록이 조회되었습니다.","data":{"items":[{"postId":1,"boardId":1,"authorPet":{"petId":2,"publicTag":"dog-2","nickname":"두부","profileUrl":null,"verified":false},"title":"산책 친구 구해요","content":"오늘 저녁 같이 산책해요.","images":[],"version":0,"createdAt":"2026-08-10T00:00:00Z","updatedAt":"2026-08-10T00:00:00Z"}],"page":{"nextCursor":"MjAyNi0wOC0xMFQwMDowMDowMFp8MQ","hasNext":true}},"error":null}
                    """)))
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "게시글 상세 조회 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            examples = @ExampleObject("""
                    {"success":true,"message":"게시글이 조회되었습니다.","data":{"postId":1,"boardId":1,"authorPet":{"petId":2,"publicTag":"dog-2","nickname":"두부","profileUrl":null,"verified":false},"title":"산책 친구 구해요","content":"오늘 저녁 같이 산책해요.","images":[],"version":0,"createdAt":"2026-08-10T00:00:00Z","updatedAt":"2026-08-10T00:00:00Z"},"error":null}
                    """)))
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "게시글 수정 성공", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
            examples = @ExampleObject("""
                    {"success":true,"message":"게시글이 수정되었습니다.","data":{"postId":1,"boardId":1,"authorPet":{"petId":2,"publicTag":"dog-2","nickname":"두부","profileUrl":null,"verified":false},"title":"수정된 제목","content":"오늘 저녁 같이 산책해요.","images":[],"version":1,"createdAt":"2026-08-10T00:00:00Z","updatedAt":"2026-08-10T00:01:00Z"},"error":null}
                    """)))
