package itda.boardpost.support;
...
public final class BoardPostCursorCodec {

    private BoardPostCursorCodec() {
    }
    ...
    public static String encode(Long id, Instant createdAt) {
    ...
    public record CursorPayload(Instant createdAt, Long postId) {
    }
}
