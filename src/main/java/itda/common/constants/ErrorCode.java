...
public enum ErrorCode {
    ...
    MEDIA_DURATION_INVALID(HttpStatus.UNPROCESSABLE_CONTENT, "허용된 미디어 길이를 초과했습니다."),
    ...
    CHAT_CLIENT_MESSAGE_ID_REQUIRED(HttpStatus.BAD_REQUEST, "사용자 전송 메시지는 clientMessageId가 필요합니다."),
    CHAT_DUPLICATE_MESSAGE(HttpStatus.CONFLICT, "동일한 clientMessageId의 메시지가 이미 존재합니다."),
    CHAT_MEDIA_ALREADY_ATTACHED(HttpStatus.CONFLICT, "이미 다른 채팅 메시지에 첨부된 미디어입니다."),
