...
| M1-020 | 7/25~7/29 | 배포 | BE-1 | BE-3 | M1-005 | 서버·DB·S3·환경변수·TLS·로그·health가 연결된 dev URL | P0 | 미착수 |
| M1-021 | 7/26~7/29 | 보안 | BE-3 | BE-1, BE-2 | M1-007 | JWT 인가, L1/L2, ADMIN 재검증, PII·secret 로그 차단 | P0 | 부분완료 |
| M1-022 | 7/28~7/29 | 복구 | BE-1 | BE-3 | M1-020 | DB 백업·복구 리허설과 증빙 | P1 | 미착수 |
| M1-023 | 7/29 | QA | 전원 | 전원 | P0 전체 | Gate 시나리오 3회 연속 성공, 치명 결함 0 | P0 | 미착수 |
| M1-024 | 7/30 | 릴리스 | BE-1 | 전원 | M1-023 | M1 배포·시연, rollback 절차 확인 | P0 | 미착수 |
| M1-025 | 7/24~7/26 | 관리자 인증 | BE-3 | BE-2 | M1-007 | `users.role`, 공통 로그인, ADMIN 접근 검사와 DB 재검증 | P0 | 부분완료 |
| M1-026 | 7/28~7/30 | 일반 관리자 | BE-3 | BE-2 | M1-013, M1-025 | 사용자·Pet·등록결과 조회·정지 API | P2 | 미착수 |
| M1-027 | 7/28~7/30 | 일반 관리자 Web | BE-3 | BE-2 | M1-004, M1-026 | 사용자·Pet·등록결과 조회·정지 화면 | P2 | 미착수 |
| M1-028 | 7/25~7/27 | 친구 API | BE-3 | BE-2 | M1-006, M1-013 | 요청·수락·거절·취소·목록·삭제, 상호요청 자동수락, 7일 만료 | P1 | 미착수 |
| M1-029 | 7/26~7/28 | Pet·친구 Web | BE-2 | BE-3 | M1-004, M1-013, M1-028 | Pet 공개 태그 검색, 친구 요청·받은·보낸·목록 화면 | P1 | 미착수 |
| M1-030 | 7/26~7/28 | 약속 카드 | BE-2 | AI-1 | M1-015, M1-033 | 2개 이상 메시지에서 버튼 활성, 초안·빈 폼 fallback·확정·조회·취소, CARD·SYSTEM polling 반영 | P0 | 미착수 |
...
M2·M3 상세 WBS는 본 문서에 넣지 않는다. M1 이후 React Native, Google 로그인, GPS 확인, 사용자 셋로그 업로드, 장소·만남·후기, 그룹 채팅, 대화 맥락 검열을 별도 문서로 추가한다.
